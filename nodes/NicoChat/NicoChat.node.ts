...
export class NicoChat implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			...
			// ===============================
			{
				...
				options: [
					...
					},
					{
						...
						action: 'Adicionar múltiplas tags',
					},
					{
						name: 'Criar',
						value: 'create',
				...
				options: [
					{
						...
						action: 'Definir múltiplos campos',
					},
					{
						name: 'Definir Valor',
						value: 'setFieldValue',
			...
			{
				displayName: 'Nome ou ID do Campo',
				name: 'fieldName',
				type: 'options',
				typeOptions: {
				...
				default: '',
				description:
					'Escolha da lista ou especifique um ID usando uma <a href="https://docs.n8n.io/code/expressions/">expressão</a>',
			},
			...
			// Flow: flow name
			{
				displayName: 'Nome ou ID do Fluxo',
				name: 'flowName',
				type: 'options',
				typeOptions: {
